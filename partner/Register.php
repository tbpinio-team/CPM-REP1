<?php
$mycon=mysqli_connect("localhost","root","","partnerdashboard");
if($mycon)
{
...
<?php 
	...
	{	
		...
		$q="INSERT INTO `users`(`user_fname`, `user_lname`, `user_email`, `user_password`) VALUES ('$user_fname','$user_lname','$user_email','$user_password')";
		$query=mysqli_query($mycon,$q);
		if($query)
							{
...
<head>
		...
		<meta charset="utf-8" />
		<title>AWT-CEP Corporate Dashboard ..:::.. Register</title>
			...
			<div class="main-content">
				...
				<form method="post">
					...
					<div class="widget-main">
						<p class="alert alert-info">ENTER YOUR FIRST NAME</p>
					</div>  
					<div class="inpbox">
					<span class="block input-icon input-icon-right">
						<input id="user_fname" class="form-control" type="text">
					</span>
					</div>
					<div style="clear:both;height:20px;"></div>
					<div class="widget-main">
						<p class="alert alert-info">ENTER YOUR LAST NAME</p>
					</div>  
					<div class="inpbox">
					<span class="block input-icon input-icon-right">
						<input id="user_lname" class="form-control" type="text">
					</span>
					</div>
					<div style="clear:both;height:20px;"></div>
					<div class="widget-main">
					...
					<div style="clear:both;height:20px;"></div>
					<button class="width-35 btn btn-sm btn-primary" type="submit" name="done">
