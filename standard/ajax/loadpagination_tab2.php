...
if($adjacents<=0) $adjacents = 4;
	...
	elseif($page==2) {
		$out.= "<li class='paginationli the_basic_buttons  paginglis paginglis_previous'><a onclick=\"load_basic_practice(1)\">" . $prevlabel . "</a>\n</li>";
	}
	else {
...
echo paginate_three('', $CurrentPage, $totalCFM, 1);
?>