	   ...
	   $.each(entry, function( i, value ) 
	    {
				...
				html += '<a href="#"><img alt="Pin This Item" src="img/pin-icon.png"></a>';
				...
				html += '</p>'
				html += '<a target="_blank" href="'+ entry[i].url +'" class="pull-right readmore"><img alt="Read More" src="img/read-more.jpg"></a>';
				html += '</div>';
				html += '</li>'
